...
public class FingerprintUiHelper extends FingerprintManager.AuthenticationCallback {
    ...
    public void onAuthenticationError(final int errMsgId, final CharSequence errString) {
        if (!mSelfCancelled) {
            ...
            mIcon.postDelayed(new Runnable() {
                @Override
                public void run() {
                    mCallback.onError(FingerprintError.Companion.fromAuthenticationError(errMsgId), errString);
                }
    ...
    public interface Callback {
        ...
        void onError(FingerprintError error, @Nullable CharSequence errString);
    }
}
